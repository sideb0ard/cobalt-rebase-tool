...
<<<<<<< HEAD:third_party/grpc/source/src/core/lib/transport/call_arena_allocator.cc
namespace grpc_core {
...
std::string GetEnvironment(std::string name) {
  ...
  return "";
>>>>>>> 254c8f5759e (Cleanup codebase by running pre-commit. (#4253)):starboard/shared/posix/environment.cc
}
